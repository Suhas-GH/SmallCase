...
class Test1ApplicationTests {
	...
	@Test
	public void registerUserWithLessInfoTest(){
	...
	@Test
	public void deleteBasketWithoutBasketTest(){
	...
	@Test
	public void addStockswithLessDataTest(){
	...
	@Test
	public void modifyStockswithLessDataTest(){
		Stocks stocks = new Stocks();
	...
	@Test
	public void deleteStockwithoutStockTest(){
	...
	@Test
	public void getStocksByMappingTest(){
	...
	@Test
	public void getInvestmentAmountTest(){
		stocksMappingSet.add(stocksMapping);
		List<Stocks> stocksList = new ArrayList<>();
		stocksList.add(stock);
	...
	@Test
	public void addToCartWithoutBasketIdTest(){
		when(securityContext.getAuthentication()).thenReturn(authentication);
		SecurityContextHolder.setContext(securityContext);
		when(authentication.getName()).thenReturn(user.getUserName());
		when(applicationUserRepository.findByUserName(user.getUserName())).thenReturn(user);
	...
	@Test
	public void deleteFromCartWithoutBasketIdTest(){
		SecurityContextHolder.setContext(securityContext);
		when(securityContext.getAuthentication()).thenReturn(authentication);
		when(authentication.getName()).thenReturn(user.getUserName());
		when(applicationUserRepository.findByUserName(user.getUserName())).thenReturn(user);
	...
	public void getUserCartTest(){
		...
		when(cartMappingRepository.findAllByCart_CartId(cart.getCartId())).thenReturn(cartMappingList);
		when(basketsRepository.findById(basket.getBasketId())).thenReturn(Optional.ofNullable(basket));
